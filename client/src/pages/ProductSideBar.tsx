					...
					<div className="shop-sidebar">
						...
						<div className="sidebar-widget post-widget">
							...
							<div className="post-inner">
								<div className="post">
									<figure className="post-thumb"><a href="shop-details.html"><img src="images/resource/products/thumb-1.jpg" alt=""/></a></figure>
									<a href="shop-product-details.html">Best Headset</a>
									<span className="price">$45.00</span>
								</div>
								<div className="post">
									<figure className="post-thumb"><a href="shop-details.html"><img src="images/resource/products/thumb-2.jpg" alt=""/></a></figure>
									<a href="shop-product-details.html">Quality Battery</a>
									<span className="price">$34.00</span>
								</div>
								<div className="post">
									<figure className="post-thumb"><a href="shop-details.html"><img src="images/resource/products/thumb-3.jpg" alt=""/></a></figure>
