					...
					<div className="service-sidebar">
						...
						<div className="sidebar-widget service-sidebar-single">
							...
							<div className="sidebar-service-list">
								<ul>
									<li><a href="page-service-details.html" className="current"><i className="fas fa-angle-right"></i><span>Website Development</span></a></li>
									<li className="current"><a href="page-service-details.html"><i className="fas fa-angle-right"></i><span>Graphic Designing</span></a></li>
									<li><a href="page-service-details.html"><i className="fas fa-angle-right"></i><span>Digital Marketing</span></a></li>
									<li><a href="page-service-details.html"><i className="fas fa-angle-right"></i><span>Apps Development</span></a></li>
									<li><a href="page-service-details.html"><i className="fas fa-angle-right"></i><span>Seo & Content Writing</span></a></li>
									<li><a href="page-service-details.html"><i className="fas fa-angle-right"></i><span>UI / UX Designing</span></a></li>
								</ul>
							</div>
