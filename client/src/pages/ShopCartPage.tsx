				...
				<table className="table table-striped table-bordered tbl-shopping-cart">
				  ...
				  <tbody>
					<tr className="cart_item">
					  ...
					  <td className="product-thumbnail"><a href="#"><img alt="product" src="images/resource/products/1.jpg"/></a></td>
					...
					<tr className="cart_item">
					  <td className="product-remove"><a title="Remove this item" className="remove" href="#">×</a></td>
					  <td className="product-thumbnail"><a href="#"><img alt="product" src="images/resource/products/2.jpg"/></a></td>
					...
					<tr className="cart_item">
					  <td className="product-remove"><a title="Remove this item" className="remove" href="#">×</a></td>
					  <td className="product-thumbnail"><a href="#"><img alt="product" src="images/resource/products/3.jpg"/></a></td>
					  ...
					  <td colSpan={3}>
						<form className="row g-3 coupon-form">
						  <div className="col-auto">
							<input type="text" name="coupon_code" className="input-text form-control mr-1" id="coupon_code" value="" placeholder="Coupon code"/>
						  </div>
						  <div className="col-auto">
			...
			<div className="col-md-12 mt-30">
			  <div className="row">
				...
				<div className="col-md-5">
				  ...
				  <a className="theme-btn btn-style-one" href="shop-checkout.html"><span className="btn-title">Proceed to Checkout</span> </a> </div>
			  </div>
			</div>
		  </div>
		</div>
