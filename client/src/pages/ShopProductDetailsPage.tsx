			...
			<div className="row">
				<div className="col-lg-6 col-xl-6">
					<div className="bxslider">
						<div className="slider-content">
							<figure className="image-box"><a href="images/resource/products/product-details.jpg" className="lightbox-image" data-fancybox="gallery"><img src="images/resource/products/product-details.jpg" alt=""/></a></figure>
							<div className="slider-pager">
								<ul className="thumb-box">
									<li> <a className="active" data-slide-index="0" href="#">
										<figure><img src="images/resource/products/product-details.jpg" alt=""/></figure>
										</a> </li>
									<li> <a data-slide-index="1" href="#">
										<figure><img src="images/resource/products/product-details2.jpg" alt=""/></figure>
										</a> </li>
									<li> <a data-slide-index="2" href="#">
										<figure><img src="images/resource/products/product-details3.jpg" alt=""/></figure>
										</a> </li>
								</ul>
							</div>
						</div>
						<div className="slider-content">
							<figure className="image-box"><a href="images/resource/products/product-details2.jpg" className="lightbox-image" data-fancybox="gallery"><img src="images/resource/products/product-details2.jpg" alt=""/></a></figure>
							<div className="slider-pager">
								<ul className="thumb-box">
									<li> <a className="active" data-slide-index="0" href="#">
										<figure><img src="images/resource/products/product-details.jpg" alt=""/></figure>
						...
						<div className="slider-content">
							<figure className="image-box"><a href="images/resource/products/product-details3.jpg" className="lightbox-image" data-fancybox="gallery"><img src="images/resource/products/product-details3.jpg" alt=""/></a></figure>
							<div className="slider-pager">
								<ul className="thumb-box">
									<li> <a className="active" data-slide-index="0" href="#">
										<figure><img src="images/resource/products/product-details.jpg" alt=""/></figure>
				...
				<div className="col-lg-6 col-xl-6 product-info">
					...
					<div className="product-details__content">
						...
						<p className="product-details__content-text2"><strong>REF.</strong> 4231/406 <br/>
					...
					<div className="product-details__quantity">
						...
						<div className="quantity-box">
							<button type="button" className="sub text-white"><i className="fa fa-minus"></i></button>
							<input type="number" id="1" value="1" />
							<button type="button" className="add text-white"><i className="fa fa-plus"></i></button>
						</div>
					</div>
					...
					<div className="product-details__buttons">
						<div className="product-details__buttons-1">
							<a href="shop-cart.html" className="theme-btn btn-style-one"><span className="btn-title">Add to Cart</span></a>
						</div>
						<div className="product-details__buttons-2">
							<a href="shop-product-details.html" className="theme-btn btn-style-one"><span className="btn-title">Add to Wishlist</span></a>
						</div>
					</div>
				...
				<div className="tabs-box">
					<div className="tab-btn-box text-center">
						<ul className="tab-btns tab-buttons clearfix">
							<li className="tab-btn active-btn" data-tab="#tab-1">Description</li>
							<li className="tab-btn" data-tab="#tab-2">Reviews</li>
						</ul>
					</div>
							...
							<div className="product-block all mix pantry fruit col-lg-3 col-md-6 col-sm-12">
								<div className="inner-box">
									...
									<div className="content">
										<h4><a href="shop-product-details.html">Headphone</a></h4>
