		...
		<header className="main-header header-style-four">
			...
			<div className="main-box">
				<div className="logo-box">
					<div className="logo"><a href="index.html"><img src="images/logo-2.png" alt="" title="Tronis"/></a></div>
				</div>
				...
				<div className="outer-box">
					<a href="tel:+92(8800)9806" className="info-btn-two d-none d-sm-block">
						...
						<small>Call Agent</small><br/>+92 888 2222
					</a>
			...
			<div className="mobile-menu">
				...
				<nav className="menu-box">
					<div className="upper-box">
						<div className="nav-logo"><a href="index.html"><img src="images/logo-2.png" alt="" title=""/></a>
						</div>
