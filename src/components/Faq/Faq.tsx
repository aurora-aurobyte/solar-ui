...
export default function Faq({}: Props) {
    return (
        <>
            {/* <!-- FAQ Section --> */}
            <section
                className="faqs-section-home2"
                style={{ backgroundImage: "url(./images/background/home-2-faq-bg.jpg)" }}
            >
                            ...
                            <div className="inner-column mb-md-50">
                                <ul className="accordion-box style-two bg-transparent p-0 wow fadeInLeft">
                                    ...
                                    <li className="accordion block active-block pl-30 pr-30">
                                        <div className="acc-btn border-bottom-0 active">
                                        ...
                                        <div className="acc-content current">
                                            <div className="content border-bottom-0 pt-0">
                                                <div className="text">
                                                    Reduce, reuse, and recycle: This is a classNameic but effective way
                                                    to reduce waste and conserve resources. Try to use reusable bags,
                                                    containers, and water bottles, and recycle items that can't be
                                                    reused.
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li className="accordion block pl-30 pr-30">
                                        <div className="acc-btn border-bottom-0">
                                    ...
                                    <div className="tab-content" id="myTabContent">
                                        ...
                                        >
                                            <div className="d-sm-flex align-items-sm-center mt-40">
                                                <div className="img flex-shrink-0 mr-20">
                                                    <img
                                                        className="rounded-circle"
                                                        src="/images/resource/home-2-tab-img-1.jpg"
                                                        alt=""
                                                    />
                                                </div>
                                                <div className="content">
                                                    ...
                                                    <p className="text">
                                                        {" "}
                                                        Maximizing green and clean resources is essential for promoting
                                                        sustainable development and reducing our impact on the
                                                        environment.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        >
                                            <div className="d-sm-flex align-items-sm-center mt-40">
                                                <div className="img flex-shrink-0 mr-20">
                                                    <img
                                                        className="rounded-circle"
                                                        src="/images/resource/home-2-tab-img-2.jpg"
                                                        alt=""
                                                    />
                                                </div>
                                                <div className="content">
