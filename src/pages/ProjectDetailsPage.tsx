				...
				<div className="col-xl-12">
					<div className="project-details__pagination-box">
						<ul className="project-details__pagination list-unstyled clearfix">
							<li className="next">
								<div className="icon"> <a href="#" aria-label="Previous"><i className="lnr lnr-icon-arrow-left"></i></a> </div>
							...
							<li className="previous">
								...
								<div className="icon"> <a href="#" aria-label="Previous"><i className="lnr lnr-icon-arrow-right"></i></a> </div>
							</li>
						</ul>
					</div>
				</div>
